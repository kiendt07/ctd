...
//tim kiem 1 ten da ton tai chua toan bo chuong trinh
...
//check 1 dinh danh da khai bao trg scope?
void checkFreshIdent(char *name) {
  if (findObject(symtab->currentScope->objList, name) != NULL)
    error(ERR_DUPLICATE_IDENT, currentToken->lineNo, currentToken->colNo);
}
//check 1 dinh danh trg toan bo ch.trinh
...
//check 1 hang da dk khai bao chua
...
//kiem tra Lvalue da khai bao chua
